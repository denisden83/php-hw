...
try {
    if (empty($_GET['client_id']) && empty($_GET['client_name'])) {
        ...
        while ($data = $result->fetch()) {
            ...
            echo "<th><a href='#' data-id='{$data['client_id']}'" .
                " data-name='{$data['client']}'>{$data['client']}</a></th>";
        ...
        echo "<button><a href='#' id='back' data-id='' data-name=''>back</a></button>";
